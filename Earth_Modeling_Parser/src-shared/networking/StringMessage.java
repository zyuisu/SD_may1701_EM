...
public class StringMessage implements Serializable{
	...
	public enum Type {ERROR_MESSAGE, MESSAGE};
	 ...
	 * @param type The StringMessage.TYPE that this type represents.
	 * @param message The String that you would like to send along with your message.
	 * @throws IllegalAccessException If a null value is passed.
	 */
