...
public class JavaScriptGenerator {
	...
	public static final String helpText = "<h2>Visualization of Earth Modeling Systems</h2> 1. Select a region.<br> 2. Select a compound.<br> 3. Select a year.<br> 4. If applicable, select a month. Currently, only CH4 is updated monthly.<br> 5. Click on the 'Load Map' button.<br><br> NOTE: Viewing freshly uploaded maps may require you to refresh your browser's cache. On most browsers, this can can be done by pressing the following buttons simultaneously: 'Ctrl+Shift+R'.";
