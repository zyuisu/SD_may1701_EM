...
public class FileLocations {
	...
	public static final String HTML_FILE_LOCATION = CURRENT_WORKING_DIRECTORY_LOCATION + "resources\\autoGeneratedJavaScript.js";
	...
	// Security file used to store the authentication details to access the GIS server.
	public static final String SERVER_AUTH_FILE_LOCATION = CURRENT_WORKING_DIRECTORY_LOCATION + "resources\\arcgis_server_manager_authentication.txt";
